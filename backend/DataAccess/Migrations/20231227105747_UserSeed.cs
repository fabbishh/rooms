    ...
    public partial class UserSeed : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "DateCreated", "Deleted", "Email", "FirstName", "IsActive", "IsEmailConfirmed", "IsPhoneNumberConfirmed", "LastName", "Login", "Patronymic", "PhoneNumber", "Role" },
                values: new object[] { new Guid("e0727b36-face-4e75-9371-54908b66fb9b"), new DateTimeOffset(new DateTime(2023, 12, 27, 10, 57, 47, 321, DateTimeKind.Unspecified).AddTicks(3694), new TimeSpan(0, 0, 0, 0, 0)), false, "user@test.ru", null, true, false, false, null, null, null, null, 3 });

            migrationBuilder.InsertData(
                table: "UserCodes",
                columns: new[] { "Id", "Code", "DateCreated", "Deleted", "Expires", "IsActive", "UserId" },
                values: new object[] { new Guid("c3cae629-e754-4f4a-858e-aff906c980a4"), "0ffe1abd1a08215353c233d6e009613e95eec4253832a761af28ff37ac5a150c", new DateTimeOffset(new DateTime(2023, 12, 27, 10, 57, 47, 321, DateTimeKind.Unspecified).AddTicks(3728), new TimeSpan(0, 0, 0, 0, 0)), false, new DateTimeOffset(new DateTime(2024, 10, 27, 10, 57, 47, 321, DateTimeKind.Unspecified).AddTicks(3729), new TimeSpan(0, 0, 0, 0, 0)), true, new Guid("e0727b36-face-4e75-9371-54908b66fb9b") });
        }
