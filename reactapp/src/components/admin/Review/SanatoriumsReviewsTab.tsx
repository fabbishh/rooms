...
import SanatoriumReviewDetailsModal from './SanatoriumReviewDetailsModal';

type Props = {}

const SanatoriumsReviewsTab = (props: Props) => {
	...
	const columns = [
        ...
        {
            cell: (row: any) => <SanatoriumReviewDetailsModal reviewId={row.id} onSave={onSave} />,
            ignoreRowClick: true,
            allowOverflow: true,
            button: true,
            center: true
	...
	const fetchData = async () => {
		try {
			var response = await api.post("/review/sanatorium-reviews/GetTableData", {
...
export default SanatoriumsReviewsTab